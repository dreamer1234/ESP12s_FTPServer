...
# Installation
- Just clone the repository and use Platformio to build and upload the code to the ESP21s board. To upload the code to the board, just remember you need to first press the BOOT button, then connect the USB cable to the board and the computer and then release the BOOT button. 
